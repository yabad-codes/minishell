...
/*   Updated: 2023/07/19 13:03:41 by ael-maar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param tokens A reference to a pointer of tokens, starting from the quotes
 * @return TRUE is matched, FALSE otherwise.
*/
int		matched_quotes(t_token *tokens);

/**
 * @brief Check if the pipe contains word type before it
 * @param prev_token The previous token, to check for word type
 * @return TRUE word type exist, FALSE otherwise.
*/
int		is_word_type_before(t_token *prev_token);

/**
 * @brief Check if the pipe or redirection contain word type after them.
 * @param token The token redirection or pipe, to check their next token.
 * @return TRUE word type exist, FALSE otherwise.
*/
...
/**
 * @brief Check for syntax error from the tokens generated by the lexer
